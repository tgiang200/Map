...
public class OrderControl {
	...
	public String createOrder(Model model, HttpServletRequest request, HttpSession session)
		...
		String meansure = request.getParameter("meansure"); // thong tin do
															// luong
		String vehicleType = request.getParameter("vehicle"); // loai phuong
																// tien van
																// chuyen
		String describe = request.getParameter("describe"); // mo ta them
		String price = request.getParameter("price"); // gia van chuyen
		String distance = request.getParameter("distance"); // khoang cach van
															// chuyen km
	...
	public String completeOrder(@PathVariable String idOrder) throws JSONException {
		...
		Double value = Double.parseDouble(newFunds) - Double.parseDouble(currentFunds);
		shipperModel.logChangeFunds("shipping",shipperID, time, value);
