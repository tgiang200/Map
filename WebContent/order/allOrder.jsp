...
<script>
	...
	document.write("<th class=\"title\" colspan=\"7\"><center><h2>Tất cả đơn hàng</h2></center></th>");
	document.write("<tr><th><center>Producer</center></th>");
	document.write("<th><center>Cửa hàng</center></th>")
	...
	for (var i=0; i<info.length; i++){
			...
			document.write("<td>"+info[i].status+"</td>");
			document.write("<td><a href=\"/Map/order/orderID="+info[i]._id.$oid+"\">Lựa chọn</a></td>");
			document.write("</tr>");
	}
	document.write("</table>");
	document.write("</div>");
