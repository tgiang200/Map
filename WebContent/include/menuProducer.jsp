		...
		<div id="navbar" class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a href="/Map/producer/createOrder.html">Tạo đơn hàng</a>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li></li>
				<li><a href="/Map/user/userType=producer&username=<%out.print(session.getAttribute("username"));%>/"><%out.print(session.getAttribute("username"));%></a></li>
